...
func (decoder *TransactionDecoder) CreateRawTransaction(wrapper openwallet.WalletDAI, rawTx *openwallet.RawTransaction) error {
	return decoder.CreateCRORawTransaction(wrapper, rawTx)
}

//SignRawTransaction 签名交易单
func (decoder *TransactionDecoder) SignRawTransaction(wrapper openwallet.WalletDAI, rawTx *openwallet.RawTransaction) error {
	return decoder.SignCRORawTransaction(wrapper, rawTx)
}

//VerifyRawTransaction 验证交易单，验证交易单并返回加入签名后的交易单
func (decoder *TransactionDecoder) VerifyRawTransaction(wrapper openwallet.WalletDAI, rawTx *openwallet.RawTransaction) error {
	return decoder.VerifyCRORawTransaction(wrapper, rawTx)
}
...
func (decoder *TransactionDecoder) CreateCRORawTransaction(wrapper openwallet.WalletDAI, rawTx *openwallet.RawTransaction) error {
	...
	addrPrefix := CRO_mainnetAddress.ChecksumType
	if decoder.wm.Config.IsTestNet {
		addrPrefix = CRO_testnetAddress.ChecksumType
	}
	...
	emptyTrans, hash, err := cryptoTx.getUnsignedTxAndHash()
	if err != nil {
		return err
	}
...
func (decoder *TransactionDecoder) SignCRORawTransaction(wrapper openwallet.WalletDAI, rawTx *openwallet.RawTransaction) error {
...
func (decoder *TransactionDecoder) VerifyCRORawTransaction(wrapper openwallet.WalletDAI, rawTx *openwallet.RawTransaction) error {
